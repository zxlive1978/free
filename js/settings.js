...
var bigPar = {
	...
	par29: { par: 'Dmk', txt: 'ДМК', min: 0, max: 100, color: '#006eea', poz: { x: 2, y: 7 }, show: true, step: 0.75, unit: 'м', log: false },
	par30: { par: 'Vbur', txt: 'Скорость бурения', min: 0, max: 100, color: '#a92ab8', poz: { x: 2, y: 7 }, show: true, step: 0.75, unit: 'м', log: false },
