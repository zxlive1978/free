...
function colOK10() {
	...
	if (curtemp=='svodka'){
		...
		bigelem= bigelem+'<iframe id="svodka" frameborder="1" style="top: 0; left: 0; border: none; margin: 0; padding: 0;box-sizing: border-box; -moz-box-sizing: border-box; -webkit-box-sizing: border-box;" name="svodka" src="https://hydrofalll.ddns.net'+cur_svodka.slice(5)+'" "></iframe>'+ '</div>';
