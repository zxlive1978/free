...
function adm (){
	...
	for (var keey in camswell) {
		...
		'<div class="caption text-center">'+
    		...
    		'<div id="progress'+camswell[keey].id + '" class="progress-bar progress-bar-striped bg-success"  role="progressbar" style="width: 70%" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100"></div></div>'+
