...
<nav class="navbar navbar-expand-md navbar-inverse  py-0 navbar-fixed-top" id="bigpan">
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    ...
    <li>
	  <div class="dropdown">
		...
		<div class="dropdown-menu" aria-labelledby="dropdownMenu2">
		<button class="dropdown-item btn" type="button" onclick='colOK11()'>Просмотр/Редактирование экрана</button>
		<button class="dropdown-item btn" type="button" onclick='colPan10()'>Выбор скважины</button> 
		<button class="dropdown-item btn" type="button" onclick='colPan3()'>Выбор даты</button>
    <button class="dropdown-item btn" type="button" onclick='colPan4()'>Видеокамера</button>
    <button class="dropdown-item btn-" type="button" onclick='colPan9()'>Загрузить/Сохранить(Создать) форму</button>
		</div>
		</div>
	  </li>
