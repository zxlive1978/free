...
<button type="button"  id="skvnamelab"  class="btn btn-outline-light bg-secondary" style="font-weight: bold; padding-top:0; padding-bottom:0; font-size: 20px;" onClick="colPan10();">Скважина ?</button>
