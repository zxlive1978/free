...
<button type="button" class="btn btn-outline-light bg-secondary" style="font-weight: bold; padding-top:0; padding-bottom:0; font-size: 16px;" onClick="exit('exit','exit','exit');">Выход</button>
