...
<button type="button" class="btn btn-outline-light bg-secondary" style=" padding-top:3; padding-bottom:3; font-size: 18px;" onClick="exit('exit','exit','exit');">Выход</button>
