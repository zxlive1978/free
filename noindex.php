...
<div class="modal fade" id="myModal2">
    <div class="modal-dialog modal-dialog-scrollable">
      <div class="modal-content">
        ...
        <!-- Modal body -->
        <div class="modal-body">
        <label for="hcolcolor">Выбор даты:</label>
...
<input type='date' class="form-control input-lg bg-dark text-light" id='localdate1' name='date1' value="<?php echo date('Y-m-d');?>" max=<?php echo date('Y-m-d');?> >
    ...
    <div class="modal-dialog modal-dialog-scrollable">
      <div class="modal-content">
        ...
        <div class="modal-header">
         ...
         <!-- Modal body -->
          <div class="modal-body">
        <label for="hcolcolor">Название скважины:</label><select class="form-control input-lg bg-dark text-light" name="karotoN" id="karotoN"  size="1" ></select>
        <br>
