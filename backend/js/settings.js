...
function adm (){
    ...
    +'<input type="date" class="form-control  " id="startdirka" name="startdirka" value="<?php echo date("Y-m-d");?>"><input type="time"  class="form-control" id="startdirka2" name="startdirka2" class="form-control  " value="01:00" min="00:00" max="24:00" required >'
    +'<label for="hcolcolor"class="control-label">Конец:</label>'
    +'<input type="date" class="form-control  " id="stopddirka" name="stopddirka" value="<?php echo date("Y-m-d");?>"><input type="time" class="form-control " id="stopddirka2" name="stopddirka2" class="form-control  " value="01:01" min="00:00" max="24:00" required >'
	+'</div>'
	+'</div></div>'
	+'dasdskkg'
	);
