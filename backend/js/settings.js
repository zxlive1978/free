...
function adm (){
	...
	+'<button type="button" class="btn btn-info" value="Input Button">  <a href="https://pfagg.ru/mon/poz/readrandom/gsdtcis.7z" style="color:inherit"> Скачать конвертор станции "Разрез" </a> </button>'
	+'</div></div>'
	+'</div></div>'
